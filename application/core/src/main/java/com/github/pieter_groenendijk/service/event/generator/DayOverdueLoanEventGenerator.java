...
public class DayOverdueLoanEventGenerator extends EventGenerator<Loan> {
    protected DayOverdueLoanEventGenerator(IEventRepository repository) {
        super(repository, EventType.DAY_OVERDUE_LOAN_EVENT);
    }
    ...
    @Override
    protected EventStorage<Loan> generateEventStorage(Loan loan) {
        // TODO: This won't work -> Hibernate can't just store a entity with a generic!
