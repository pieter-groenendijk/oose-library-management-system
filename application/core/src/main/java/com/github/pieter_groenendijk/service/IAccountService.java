...
public interface IAccountService {
    ...
    Account store(AccountRequestDTO account) throws Exception;

    Account update(Account account) throws Exception;

    Account update(long id, AccountRequestDTO account) throws Exception;
    ...
    void setIsActive(long id, boolean newValue) throws Exception;
