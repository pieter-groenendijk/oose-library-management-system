...
public class AccountService implements IAccountService {
    ...
    public Account store(AccountRequestDTO request) throws Exception {
    ...
    public Account update(long id, AccountRequestDTO account) throws Exception {
    ...
    public void setIsActive(long id, boolean newValue) throws Exception {
        Account retrievedAccount =  retrieveAccountById(id);
        if (retrievedAccount == null) {
            throw new EntityNotFoundException("Account with ID " + id + " not found.");
        }
